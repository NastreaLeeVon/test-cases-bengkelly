...
// TC-85-transfer-stok
// Source: test-cases/TC-85-transfer-stok.md

test.describe('TC-85: Admin ingin mencari transfer stok dan mengurutkan transfer stok berdasarkan filter', () => {
  ...
  test('Admin ingin mencari transfer stok dan mengurutkan transfer stok berdasarkan filter', async ({ page }) => {
