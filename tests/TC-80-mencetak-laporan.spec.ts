...
// TC-80-mencetak-laporan
// Source: test-cases/TC-80-mencetak-laporan.md

test.describe('TC-80: Admin ingin mencetak laporan', () => {
  ...
  test('Admin ingin mencetak laporan', async ({ page }) => {
