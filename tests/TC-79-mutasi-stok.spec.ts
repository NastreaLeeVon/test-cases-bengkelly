...
// TC-79-mutasi-stok
// Source: test-cases/TC-79-mutasi-stok.md

test.describe('TC-79: Admin ingin mencari mutasi stok dan mengurutkan mutasi stok berdasarkan filter', () => {
  ...
  test('Admin ingin mencari mutasi stok dan mengurutkan mutasi stok berdasarkan filter', async ({ page }) => {
