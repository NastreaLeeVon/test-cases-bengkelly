...
// TC-101-mencetak-laporan-dalam-langsung
// Source: test-cases/TC-101-mencetak-laporan-dalam-langsung.md

test.describe('TC-101: Admin ingin mencetak laporan dalam detail pembelian langsung', () => {
  ...
  test('Admin ingin mencetak laporan dalam detail pembelian langsung', async ({ page }) => {
