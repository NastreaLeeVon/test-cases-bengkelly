...
// TC-93-file-stock-opname
// Source: test-cases/TC-93-file-stock-opname.md

test.describe('TC-93: Admin ingin melakukan print data file Stock Opname', () => {
  ...
  test('Admin ingin melakukan print data file Stock Opname', async ({ page }) => {
    ...
    // - Menampilkan data lengkap stock opname
