...
// TC-77-mutasi-stok
// Source: test-cases/TC-77-mutasi-stok.md

test.describe('TC-77: Admin ingin melihat ringkasan data mutasi stok', () => {
  ...
  test('Admin ingin melihat ringkasan data mutasi stok', async ({ page }) => {
