...
// TC-66-barang
// Source: test-cases/TC-66-barang.md

test.describe('TC-66: Admin ingin mencari Penerimaan Barang dan mengurutkan Penerimaan Barang berdasarkan filter', () => {
  ...
  test('Admin ingin mencari Penerimaan Barang dan mengurutkan Penerimaan Barang berdasarkan filter', async ({ page }) => {
