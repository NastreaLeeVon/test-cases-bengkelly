...
// TC-81-transfer-stok
// Source: test-cases/TC-81-transfer-stok.md

test.describe('TC-81: Admin ingin melihat data ringkasan transfer stok', () => {
  ...
  test('Admin ingin melihat data ringkasan transfer stok', async ({ page }) => {
