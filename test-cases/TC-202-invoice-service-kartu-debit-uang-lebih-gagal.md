# TC-202: Invoice Service Pembayaran Kartu Debit Uang Lebih Gagal

Sebagai Admin, Owner, cashier setelah PKB dan QC selesai selanjutnya saya ingin membuat Invoice Pembayaran untuk pelanggan (Namun bagaimana jika kondisi pembayaran dengan uang yang lebih mengunakan metode Kartu Debit) (Failed)

## Deskripsi

Test case manual untuk memvalidasi bahwa pembayaran kartu debit dengan nominal lebih dari tagihan ditolak sistem. (Sesuai referensi TC_27).
...
## Skenario: Sebagai Admin, Owner, cashier setelah PKB dan QC selesai selanjutnya saya ingin membuat Invoice Pembayaran untuk pelanggan (Namun bagaimana jika kondisi pembayaran dengan uang yang lebih mengunakan metode Kartu Debit)
